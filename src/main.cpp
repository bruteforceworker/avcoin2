...
const string strMessageMagic = "ACoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ACoin
    bool fStrictPayToScriptHash = true; // Always active in ACoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ACoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Tole je pa že resen coin moj trteji po vrsti,..";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1410637815; //sobota, 13 Sep 2014 
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2881743;
        ...
        assert(block.hashMerkleRoot == uint256("0x90036c6e536b23e6615745207df2444466b092ae15ace5ec4c3474b82586344f"));//prej se je zacel na c044...
...
unsigned char pchMessageStart[4] = { 0x32, 0xf5, 0xd2, 0xea };
